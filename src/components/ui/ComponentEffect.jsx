...
export const GridItemCustom = ({
  ...
  return (
    (<li className={`min-h-[10rem] list-none ${area}`}>
      <div
        className={`relative h-full rounded-2.5xl ${isDarkMode ? "border-none" : "border border-gray-600"}  p-2  md:rounded-3xl md:p-3`}>
        <GlowingEffect
          blur={0}
          borderWidth={3}
          spread={80}
        ...
        <div
          ...
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            ...
            <div className="space-y-3 text-center">
              <h3
                className="pt-0.5 text-xl/[18px] font-semibold -tracking-4 md:text-lg/[0.75rem] text-balance text-black dark:text-white">
                {title}
              </h3>
              <h2
                className="[&_b]:md:font-semibold [&_strong]:md:font-semibold font-sans text-sm/[1.125rem] 
