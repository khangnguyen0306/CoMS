...
import { Input, Button, DatePicker, Select, Divider, Space, Spin, Modal, Checkbox, Table, InputNumber, Typography, Popover, Skeleton, message, Form } from 'antd';
...
const ContractAppendixPage = () => {
    ...
    // if (isLoadingAppendix || isLoadingContractDetail || isLoadingContracts || (appendixId && loadingData)) {
    //     return (
    ...
    const updateTotalContractValue = () => {
